    ...
    <div class="container">
      ...
      <div class="jumbotron">
		...
		if(isset($_GET['seite']))
		{
			switch($_GET['seite'])
			{
                case 'update': include('pages/update.php'); break;
			    case 'search': include('pages/suche.php'); break;
				case 'immobilie': include('pages/immobilien.php'); break;
				case 'raum': include('pages/raum.php'); break;
