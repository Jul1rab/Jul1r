...
function makeTypeBoxValueStay($labelName, $paramName, $type, $value = null, $placeholder){
    ?>
    <div class="form-group row">
        <label for="text" class="col-4 col-form-label"><?=$labelName ?></label>
        <div class="col-8">
            ...
            echo '<input value="'.$value.'" id="'.$paramName.'" name="'.$paramName.'" type="'.$type.'" placeholder="'.$placeholder.'" class="form-control">';
            ?>
        </div>
    </div>
    <?php
